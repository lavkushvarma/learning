...
export default function Portfolio() {
  ...
  const AnimatedCard = ({ children, className = "", hoverEffect = "lift" }) => {
    ...
    return (
      <Card
        className={`
          border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg
                  ...
                  {[
                    ...
                    <AnimatedCard key={index} hoverEffect="scale" className="p-4">
                      <CardContent className="p-0 flex items-center space-x-3">
                        <div className="text-violet-600 dark:text-violet-400">{item.icon}</div>
                        <div>
          ...
          <div className="container mx-auto">
            ...
            <div className="max-w-6xl mx-auto">
              {experience.map((exp, index) => (
                <div key={index} className="relative mb-16 last:mb-0 experience-item">
                  <div className="flex items-start space-x-8">
                    {/* Step Number */}
                    <div className="flex-shrink-0 relative">
                      <div className="w-16 h-16 bg-gradient-to-r from-violet-600 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg hover:scale-110 transition-transform duration-300">
                        {exp.step}
                      </div>
                      {index < experience.length - 1 && (
                        <div className="absolute left-8 top-16 w-0.5 h-20 bg-gradient-to-b from-violet-300 to-purple-300 dark:from-violet-700 dark:to-purple-700" />
                      )}
                    </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {exp.technologies.map((tech, idx) => (
                              <Badge
                                key={idx}
                                className="bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:scale-105 transition-all duration-300 shadow-sm hover:shadow-md"
                              >
                                {tech}
                              </Badge>
                            ))}
                ...
                >
                  <div className={index % 2 === 1 ? "lg:col-start-2" : ""}>
                    <motion.div className="relative group">
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${project.color} rounded-3xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500`}
                      />
                      <AnimatedCard
                        hoverEffect="lift"
                        className="relative bg-white dark:bg-gray-800 rounded-3xl overflow-hidden border border-violet-200 dark:border-gray-700 shadow-xl"
                      >
                        <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                          <Play className="w-16 h-16 text-gray-400 dark:text-gray-500 group-hover:text-violet-500 transition-colors duration-300" />
                        </div>
                      </AnimatedCard>
                    </motion.div>
                  </div>
                  ...
                  <div className={index % 2 === 1 ? "lg:col-start-1 lg:row-start-1" : ""}>
                    <div>
                      <Badge
                        className={`bg-gradient-to-r ${project.color} text-white mb-4 px-4 py-2 hover:scale-105 transition-all duration-300 shadow-lg`}
                      >
                        Featured Project
                      </Badge>
                      <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300">
                        {project.title}
                      </h3>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {project.features.map((feature, idx) => (
                            <div key={idx} className="flex items-center space-x-2 group">
                              <div className="w-2 h-2 bg-violet-500 rounded-full group-hover:scale-150 transition-transform duration-300" />
                              <span className="text-gray-600 dark:text-gray-300 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">
                                {feature}
                              </span>
                            </div>
                          ))}
                  ...
                  >
                    <CardContent className="p-0 flex-1 flex flex-col justify-between">
                      ...
                      <div className="mb-4 flex justify-center">
                        <div className="w-16 h-16 bg-white dark:bg-gray-800 rounded-xl shadow-sm flex items-center justify-center p-2 group-hover:scale-110 transition-transform duration-300">
                          <img
                            src={skill.image || "/placeholder.svg"}
                            alt={`${skill.name} logo`}
                      ...
                      {/* Technology Name */}
                      <h3 className="font-bold text-gray-900 dark:text-white mb-1 text-lg group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors">
                        {skill.name}
                      </h3>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <AnimatedCard
                    key={index}
                    hoverEffect="lift"
                    className="text-center p-6 border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg category-summary-item"
                  >
                    <CardContent className="p-0">
                      <div
                        className={`bg-gradient-to-r ${category.color} p-3 rounded-full w-fit mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                      >
                        <div className="text-white font-bold text-lg">{category.count}</div>
                      </div>
                      <h3 className="font-bold text-gray-900 dark:text-white mb-2 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">
                        {category.title}
                      </h3>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="testimonial-item">
                  <AnimatedCard hoverEffect="lift" className="h-full border-violet-200 dark:border-gray-700 shadow-xl">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        <Quote className="w-8 h-8 text-violet-600 dark:text-violet-400 group-hover:scale-110 transition-transform duration-300" />
                      </div>
                      <p className="text-gray-700 dark:text-gray-300 mb-6 italic leading-relaxed">{`"${testimonial.content}"`}</p>
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-semibold text-gray-900 dark:text-white group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">
                            {testimonial.name}
                          </h4>
                        ...
                        <div className="flex">
                          {[...Array(testimonial.rating)].map((_, i) => (
                            <Star
                              key={i}
                              className="w-4 h-4 text-yellow-400 fill-current hover:scale-110 transition-transform duration-300"
                            />
                          ))}
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <a
                        ...
                        className="flex items-center space-x-4 p-4 rounded-lg bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm border border-violet-200 dark:border-gray-600 hover:shadow-lg transition-all duration-300 hover:scale-105 hover:border-violet-400 dark:hover:border-violet-500 group"
                      >
                        <div className="text-violet-600 dark:text-violet-400 group-hover:scale-110 transition-transform duration-300">
                          {contact.icon}
                        </div>
                        <div>
                          <div className="text-sm text-gray-600 dark:text-gray-400">{contact.label}</div>
                          <div className="text-gray-900 dark:text-white font-medium group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">
                            {contact.value}
                          </div>
                        </div>
                      </a>
                  ...
                  <div className="flex space-x-3">
                    {[
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`p-3 bg-white dark:bg-gray-800 ${social.color} hover:text-white rounded-xl transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105 border border-gray-200 dark:border-gray-700`}
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <li key={service} className="flex items-start group">
                        <div className="w-2 h-2 bg-violet-400 rounded-full mt-2 mr-3 flex-shrink-0 group-hover:scale-150 transition-transform duration-300"></div>
                        <span className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">
                          {service}
                        </span>
                      </li>
                    ))}
